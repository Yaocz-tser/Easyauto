...
from Easyauto.har2case.core import HarParser
...
from Easyauto import __description__, __version__
...
def main():
    ...
    parser.add_argument(
        '-project',
        help="Create an Easyauto automation test project.")
    ...
    if args.version:
        print("Easyauto {}".format(__version__))
        return 0
...
'''
    test_sample = '''import Easyauto
from Easyauto import file_data
...
class DDTTest(Easyauto.TestCase):
...
'''
    run_test = """import Easyauto


if __name__ == '__main__':
    # run test file
    # Easyauto.main("./test_dir/test_sample.py")
    # run test dir
    Easyauto.main("./test_dir/")
